...
> 📎 Voltar ao [INDEX principal](../INDEX.md)

| Arquivo | O que tem |
|---|---|
| [arquitetura.md](arquitetura.md) | Camadas do bot, fluxo de mensagem, módulos, regras |
| [como-consultar-tabela.md](como-consultar-tabela.md) | **Passo a passo: adicionar nova consulta via WhatsApp** |
...
## Veja também
- [APIs e Chaves](../02-apis-e-chaves/INDEX.md) — chaves do Gemini, Deepgram, Evolution API
- [Deploy](../03-deploy/INDEX.md) — Vercel, Railway
- [Testes](../06-testes/INDEX.md) — política obrigatória de testes
