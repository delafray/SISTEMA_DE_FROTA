...
import { PageHeader, FormSection, FormField, inputStyle, Btn } from "@/components/ui/ds";
...
export default function NovaEmpresaPage() {
  ...
  const setRaw = (k: keyof typeof form, val: string) =>
    setForm((f) => ({ ...f, [k]: val }));
            ...
            <FormSection title="Endereço">
              <div className="m-grid" style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: "16px" }}>
                ...
                <FormField label="Número">
                  <input id="numero-empresa" value={form.numero} onChange={set("numero")} style={{ ...inputStyle, textTransform: "uppercase" }} />
                </FormField>
                ...
                <FormField label="UF">
                  <input value={form.uf} onChange={set("uf")} maxLength={2} style={{ ...inputStyle, textTransform: "uppercase", textAlign: "center" }} />
                </FormField>
              </div>
            </FormSection>
